    ...
    public class Readarr : ApplicationBase<ReadarrSettings>
    {
        ...
        public override void RemoveIndexer(int indexerId)
        {
            ...
            if (indexerMapping != null)
            {
                ...
                _readarrV1Proxy.RemoveIndexer(int.Parse(indexerMapping.RemoteIndexerId), Settings);
        ...
        public override void UpdateIndexer(IndexerDefinition indexer)
        {
            ...
            var readarrIndexer = BuildReadarrIndexer(indexer, indexer.Protocol, remoteId);

            var remoteIndexer = _readarrV1Proxy.GetIndexer(remoteId, Settings);
